...
module Billing
  module Lifetime
    ...
    # `revoked_at` (and `revoked_by_user_id`) so the audit trail
    ...
    module RevokePassService
      ...
      def call(pass:, revoked_by:, notes: nil)
        ...
        pass.update!(
          ...
          revoked_by_user_id: GrantPassService.granted_by_user_id_from(revoked_by),
        ...
        Seams::Events::Publisher.publish(
          ...
          object:       { id: pass.id, plan_ref: pass.plan_ref, revoked_by_user_id: pass.revoked_by_user_id }
        )
